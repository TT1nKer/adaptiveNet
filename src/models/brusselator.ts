...
— 默认：从均匀不动点形成干净的条纹。
— 把 b 降到 ~5：更小幅度图样，有时是斑点而非条纹。
— 把 D_v / D_u 降到 ~1：亚临界，无图样。
...
— Default: clean stripes from the homogeneous fixed point.
— Lower b to ~5: smaller-amplitude pattern, sometimes spots instead of stripes.
— Drop D_v / D_u to ~1: subcritical, no pattern.
