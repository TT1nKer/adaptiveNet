...
— P=200（已超经典 α_c=0.138）：经典 Hopfield 崩溃；现代版仍清晰检索。
— P=1000 加 N=1024（α≈1.0）：经典上限的十倍，仍工作。
— 降低 β：检索变成图样的混合而非最近的那个——低温度注意力做的事。
...
— P=200 (past classical α_c=0.138): classical Hopfield collapses; modern still recalls cleanly.
— P=1000 with N=1024 (α≈1.0): ten times past classical's limit, still works.
— Lower β: retrieval becomes a mixture of patterns rather than the closest one — what attention with low temperature does.
