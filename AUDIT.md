...
| 12 | `lif.ts` | Lapicque (1907) | ✅ verified 2026-05-04 (textbook LIF model, Gerstner-Kistler-Naud-Paninski "Neuronal Dynamics" reference). dV/dt = -V/τ + Σ synaptic_kicks + I_drive standard. Acceptance tests 2/2 pass: default → firing rate 0.17 (waves active); I_drive=0, weak coupling → firing rate 0 (silent). See `tests/lif.test.ts`. |
